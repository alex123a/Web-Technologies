<html>
    ...
    <body>
        <form action="<?php echo route("albums.store") ?>"  method="POST">
            ...
            <?php 
            if ($errors->get("release_date") != null) {
                echo implode("|",$errors->get("release_date"));
            }
            ?>
            <div id="yearDiv">
            ...
            <?php 
            if ($errors->get("artist") != null) {
                echo implode("|",$errors->get("artist"));
            }
            ?>
            <div id="artistDiv">
                <label>Select artist:</label>
                <select name="artist" id="artist">
                    <option value="11">børge</option>
            ...
            <textarea id="description_text_area" name="description" rows="3" cols="60" required></textarea><br><br>
